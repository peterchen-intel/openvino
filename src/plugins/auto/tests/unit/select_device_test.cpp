    ...
    void SetUp() override {
        ON_CALL(*plugin, select_device)
            .WillByDefault([this](const std::vector<DeviceInformation>& metaDevices,
                                  ...
                                  unsigned>& utilization_thresholds) {
...
const std::vector<ConfigFilterParams> testValidConfigs = {
    ...
    ConfigFilterParams{testUtilizThreshold_80,
                       ...
                       {{"Total", 15.3f}, {"00000000", 20.5f}},
                       {"GPU", {}, -1, "01", "GPU", 0}},
    ConfigFilterParams{testUtilizThreshold_80,
                       {{"CPU", {}, -1, "01", "CPU_01", 0}, {"NPU", {}, -1, "01", "NPU", 0}},
                       {{"Total", 15.3f}, {npuUuid, 20.5f}},
                       {"NPU", {}, -1, "01", "NPU", 0}},
    ConfigFilterParams{
        testUtilizThreshold_80,
        {{"CPU", {}, -1, "01", "CPU_01", 0}, {"GPU", {}, -1, "01", "GPU", 0}, {"NPU", {}, -1, "01", "NPU", 0}},
        {{"Total", 85.2f}, {"00000000", 20.5f}, {npuUuid, 20.5f}},
        {"GPU", {}, -1, "01", "GPU", 0}},
    ConfigFilterParams{testUtilizThreshold_15,
                       {{"CPU", {}, -1, "01", "CPU_01", 0}, {"GPU", {}, -1, "01", "GPU", 0}},
                       {{"Total", 85.2f}, {"00000000", 20.5f}},
                       {"GPU", {}, -1, "01", "GPU", 0}},
    ConfigFilterParams{testUtilizThreshold_15,
                       {{"CPU", {}, -1, "01", "CPU_01", 0}, {"GPU", {}, -1, "01", "GPU", 0}},
                       {{"Total", 10.5f}, {"00000000", 20.5f}},
                       {"CPU", {}, -1, "01", "CPU_01", 0}},
    ConfigFilterParams{testUtilizThreshold_80,
                       {{"CPU", {}, -1, "01", "CPU_01", 1}, {"GPU", {}, -1, "01", "GPU", 2}},
                       {{"Total", 25.5f}, {"00000000", 20.5f}},
                       {"CPU", {}, -1, "01", "CPU_01", 1}},
    ConfigFilterParams{testUtilizThreshold_80,
                       {{"CPU", {}, -1, "01", "CPU_01", 1}, {"GPU", {}, -1, "01", "GPU", 2}},
                       {{"Total", 90.5f}, {"00000000", 25.5f}},
                       {"GPU", {}, -1, "01", "GPU", 2}},
    ConfigFilterParams{testUtilizThreshold_80,
                       {{"CPU", {}, -1, "01", "CPU_01", 1}, {"NPU", {}, -1, "01", "NPU", 2}},
                       {{"Total", 85.5f}, {npuUuid, 20.5f}},
                       {"NPU", {}, -1, "01", "NPU", 2}},
    ConfigFilterParams{testUtilizThreshold_15,
                       {{"CPU", {}, -1, "01", "CPU_01", 1}, {"GPU", {}, -1, "01", "GPU", 2}},
                       {{"Total", 85.5f}, {"00000000", 20.5f}},
                       {"CPU", {}, -1, "01", "CPU_01", 1}},
    ConfigFilterParams{testUtilizThreshold_15,
                       {{"CPU", {}, -1, "01", "CPU_01", 0}, {"GPU.0", {}, -1, "01", "iGPU_01", 0}},
                       {{"Total", 85.5f}, {"00000001", 20.5f}},
                       {"GPU.0", {}, -1, "01", "iGPU_01", 0}},
    ConfigFilterParams{testUtilizThreshold_15,
                       {{"CPU", {}, -1, "01", "CPU_01", 0},
                        {"GPU.0", {}, -1, "01", "iGPU_01", 0},
                        {"GPU.1", {}, -1, "01", "dGPU_01", 0}},
                       {{"Total", 85.5f}, {"00000001", 20.5f}, {"00000002", 50.5f}},
                       {"GPU.1", {}, -1, "01", "dGPU_01", 0}},
    ConfigFilterParams{testUtilizThreshold_80,
                       {{"CPU", {}, -1, "01", "CPU_01", 0},
                        {"GPU.0", {}, -1, "01", "iGPU_01", 0},
                        {"GPU.1", {}, -1, "01", "dGPU_01", 0},
                        {"NPU", {}, -1, "01", "NPU", 0}},
                       {{"Total", 85.5f}, {"00000001", 20.5f}, {"00000002", 50.5f}, {npuUuid, 30.5f}},
                       {"GPU.1", {}, -1, "01", "dGPU_01", 0}},
    ConfigFilterParams{testUtilizThreshold_80,
                       {{"CPU", {}, -1, "01", "CPU_01", 0},
                        {"GPU.0", {}, -1, "01", "iGPU_01", 0},
                        {"GPU.1", {}, -1, "01", "dGPU_01", 0},
                        {"NPU", {}, -1, "01", "NPU", 0}},
                       {{"Total", 85.5f}, {"00000001", 82.5f}, {"00000002", 50.5f}, {npuUuid, 30.5f}},
                       {"GPU.1", {}, -1, "01", "dGPU_01", 0}},
    ConfigFilterParams{testUtilizThreshold_80,
                       {{"CPU", {}, -1, "01", "CPU_01", 0},
                        {"GPU.0", {}, -1, "01", "iGPU_01", 0},
                        {"GPU.1", {}, -1, "01", "dGPU_01", 0}},
                       {{"Total", 15.5f}, {"00000001", 90.5f}, {"00000002", 50.5f}},
                       {"GPU.1", {}, -1, "01", "dGPU_01", 0}},
    ConfigFilterParams{testUtilizThreshold_80,
                       {{"CPU", {}, -1, "01", "CPU_01", 0},
                        {"GPU.0", {}, -1, "01", "iGPU_01", 0},
                        {"GPU.1", {}, -1, "01", "dGPU_01", 0}},
                       {{"Total", 15.5f}, {"00000001", 10.5f}, {"00000002", 90.5f}},
                       {"GPU.0", {}, -1, "01", "iGPU_01", 0}},
    ConfigFilterParams{testUtilizThreshold_80,
                       {{"CPU", {}, -1, "01", "CPU_01", 1},
    ...
    ConfigFilterParams{testUtilizThreshold_80,
                       {{"CPU", {}, -1, "01", "CPU_01", 1},
                        ...
                        {"GPU.1", {}, -1, "01", "dGPU_01", 3},
                        {"NPU", {}, -1, "01", "NPU", 4}},
                       {{"Total", 15.5f}, {"00000001", 10.5f}, {"00000002", 90.5f}, {npuUuid, 88.5f}},
                       {"CPU", {}, -1, "01", "CPU_01", 1}},
    ConfigFilterParams{testUtilizThreshold_100,
                       {{"CPU", {}, -1, "01", "CPU_01", 1},
                        ...
                        {"GPU.1", {}, -1, "01", "dGPU_01", 3},
                        {"NPU", {}, -1, "01", "NPU", 4}},
                       {{"Total", 200.0f}, {"00000001", 200.0f}, {"00000002", 200.0f}, {npuUuid, 200.0f}},
                       {"CPU", {}, -1, "01", "CPU_01", 1}},
    ConfigFilterParams{testUtilizThreshold_80,
                       {{"CPU", {}, -1, "01", "CPU_01", 1},
                        {"GPU.0", {}, -1, "01", "iGPU_01", 2},
                        {"GPU.1", {}, -1, "01", "dGPU_01", 3}},
                       {{"Total", 15.0f}, {"00000001", 90.0f}, {"00000002", 10.0f}},
                       {"CPU", {}, -1, "01", "CPU_01", 1}}};
